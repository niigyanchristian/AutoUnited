...
<ScrollView 
    ...
    contentContainerStyle={{gap:20,paddingHorizontal:'2%'}}>
        {data.map((item)=>(
          <View key={item.id} style={{backgroundColor:!toggleBgColor?colors.secondary:colors.primary,width:width*0.7,borderRadius:width*0.06,padding:width*0.04,overflow:'hidden',elevation:2,marginVertical:'1%'}}>
