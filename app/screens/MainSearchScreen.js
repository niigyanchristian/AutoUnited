      ...
      return(
        <View style={{backgroundColor:theme.secondary,width:width*0.98,marginVertical:'1%',borderRadius:10,overflow:'hidden',flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={{width:width*0.72,padding:'2%'}}>
                ...
                <AppText width={'95%'} color={theme.white} numberOfLines={2} fontSize={width*0.035}>123456789012345</AppText>
                <AppText color={theme.white} fontFamily={"PoppinsSemiBold"} fontSize={width*0.045}>GH₵ {item.price}</AppText>
                <Rating rating={item.rate} size={0.8}/>
            </View>
        </View>
      )}}
      />}
